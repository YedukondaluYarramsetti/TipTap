                ...
                case .success:
                    ...
                    if self.selectedFor == "restaurant"{
                        ...
                        DispatchQueue.main.async{
                            ...
                            self.starsView.rating = self.selectedCuisine[0].itemAverageRating ?? 0.0
                            self.starsView.text = "\(self.selectedCuisine[0].itemAverageRating ?? 0.0)"
...
//  
    ...
    func fetchItemRatingJsonData(Item: ItemCompleteData) {
        ...
        DispatchQueue.main.async {
            ...
            self.starsView.text = String(format: "%.2f", averageRating)
    ...
    func updateAverageRating(with updatedRating: Int) {
        if let restaurantRatings = self.restaurantRatingsDataArray as? [RestaurantRatingData] {
            ...
            DispatchQueue.main.async {
                self.ratedOutofLabel.text = "Rated \(self.getRatingAfterDelate) out of 5"
            }
        } else {
